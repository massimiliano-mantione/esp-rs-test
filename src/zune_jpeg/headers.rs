...
use crate::zune_core::bytestream::ZReaderTrait;
use crate::zune_core::colorspace::ColorSpace;

use super::components::Components;
use super::decoder::{ICCChunk, JpegDecoder, MAX_COMPONENTS};
use super::errors::DecodeErrors;
use super::huffman::HuffmanTable;
use super::misc::{SOFMarkers, UN_ZIGZAG};
...
pub(crate) fn parse_start_of_frame<T: ZReaderTrait>(
    ...
    // log::info!("Image width  :{}", img_width);
    // log::info!("Image height :{}", img_height);
    ...
    // log::info!("Image components : {}", num_components);
    ...
    if num_components == 1 {
        ...
        // log::debug!("Overriding default colorspace set to Luma");
    }
...
pub(crate) fn parse_app14<T: ZReaderTrait>(
    ...
    if decoder.stream.peek_at(0, 5) == Ok(b"Adobe") {
        ...
        log::error!("Not a valid Adobe APP14 Segment");
    }
...
pub(crate) fn parse_app1<T: ZReaderTrait>(
    ...
    if length > 6 && decoder.stream.peek_at(0, 6).unwrap() == b"Exif\x00\x00" {
        ...
        // log::warn!("Wrongly formatted exif tag");
    }
